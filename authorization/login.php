...
$query = $conn->prepare('SELECT a.korisnicko_ime, a.lozinka, a.tip_korisnika_id, b.naziv as tip_korisnika FROM korisnik a INNER JOIN tip_korisnika b on a.tip_korisnika_id = b.tip_korisnika_id
